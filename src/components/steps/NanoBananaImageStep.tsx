...
export const NanoBananaImageStep: React.FC<NanoBananaImageStepProps> = ({
  ...
  const generateImage = async (
    ...
    try {
      ...
      // 스타일과 품질 추가
      finalPrompt = `${finalPrompt}\n\n스타일: ${imageConfig.style}, 품질: ${imageConfig.quality}, 비율: ${imageConfig.aspectRatio}`;
      ...
      if (attachedImages.length > 0) {
        ...
        result = await nanoBananaService.generateImage({
          ...
          aspectRatio: imageConfig.aspectRatio as any,
          quality: imageConfig.quality as any,
          style: imageConfig.style as any
        });
      }
